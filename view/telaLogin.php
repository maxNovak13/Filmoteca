            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="telaLogin.php">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="cadastrarUsuario.php">Criar Conta</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <main>
        <div class="container">
            ...
            <form method="POST" action="../control/controleUsuario.php">
                ...
                <button type="submit" class="btn btn-success" name="opcao" value="Entrar"
                    style="background-color:#FFA500; border-color:#FFA500;">Entrar</button>
                <a class="btn btn-primary" href="cadastrarUsuario.php"
                    style="background-color:#ff669c; border-color:#ff669c;">Criar conta<a>
            </form>
